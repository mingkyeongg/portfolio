      ...
      >
        <Grid templateColumns="repeat(2, 1fr)" gap="24px" width="100%">
          <ProjectTemplete
            ...
            introduction="Project 1 Description"
            content={
              <Text
              ...
              >
                ...
                진해노인종합복지관 202명의 설문조사로 요구사항을 도출하여 기능
                정의에 활용하였습니다.
              </Text>
            }
            people="2명"
            role="프론트엔드 개발자"
            techStack="React, Next.js, TypeScript, Tailwind CSS, Redux, Redux Toolkit, React Router, React Query, React Hook Form, React Testing Library, Jest, React Testing Library, Jest, React Testing Library, Jest"
            projectType="Web"
            projectLinkBadges={[
          ...
          <ProjectTemplete
            ...
            people="2명"
            role="프론트엔드 개발자"
            techStack="iOS (XCode), Swift, ROS2 Humble, Raspberry pi 5
Python, C++, Mosquitto"
            projectType="Mobile"
            projectLinkBadges={[
              { text: "Youtube", href: "https://www.youtube.com" },
